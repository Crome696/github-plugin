...
export const workflowGraphs: Record<string, WorkflowGraph> = {
  ...
  "address-pr-feedback": {
    ...
    steps: [
      ...
      read("build-feedback-lifecycle-plan", "FeedbackLifecyclePlan"),
      write("create-worktree", "BranchWorkspace"),
      read("verify-worktree", "BranchWorkspace"),
      ...
      write("create-commit", "CommitProposal"),
      write("push-branch", "BranchPush"),
      read("reload-feedback-head", "FeedbackLifecycleRun"),
  ...
  "integrate-pr": {
    ...
    steps: [
      ...
      read("load-pr-discussions", "LoadedPullRequestDiscussions"),
      read("inspect-pr-checks", "PullRequestCheckInspection"),
      read("check-required-approvals", "RequiredApprovalInspection"),
      read("check-open-review-threads", "OpenReviewThreadAssessment"),
      read("load-linked-issue", "LinkedIssue"),
      read("check-linked-issue-status", "LinkedIssueStatusAssessment"),
      read("build-pr-readiness-evidence", "PullRequestReadinessEvidence"),
