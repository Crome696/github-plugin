...
| `ParentTrackerSynchronization` | Version 1 exact-evidence parent tracker result from a complete ProductSubIssuePublication v2, including current child states, deterministic marker-owned rendering, exact body-only authorization, concurrency protection, write effect, and metadata-preserving verification. |
